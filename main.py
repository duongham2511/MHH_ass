...
def f_th_scr_07(u_th_scr,k_th_scr,g,t_air,t_top,p_air,p_top):
...
def f_vent_roof_side_10(c_d,c_w,a_flr,u_roof,u_side,a_roof,a_side,h_sideroof,g,t_air,t_out,v_wind):
...
if __name__ == '__main__':
    test1 = f_th_scr_07(0.8,0.2,9.8,37,38,0.9,1.0)
    print(test1)
